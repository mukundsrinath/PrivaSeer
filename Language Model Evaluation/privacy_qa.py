...
def train(model, optimizer, _train=_train, train_labels=train_labels, validation=validation, validation_labels=validation_labels, num_epochs = 5, eval_every = 500, file_path = destination_folder, best_valid_loss = float("Inf")):
            ...
            if global_step % eval_every == 0:
                ...
                with torch.no_grad():  
                    for val_labels, val_text_ids, val_text_masks, in batch(validation, validation_labels):
                        ...
                        valid_loss = valid_loss_func(output.double(), val_labels)
