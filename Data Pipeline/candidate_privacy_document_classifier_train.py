...
with open('/data/privseer/data/metadata5') as f:
...
df = pd.read_csv('/data/privseer/data/labels.txt')
...
#probas = clf.predict_proba(dev_x)
...
#skplt.metrics.plot_roc_curve(test_y, probas, title=None, curves=["each_class"])
